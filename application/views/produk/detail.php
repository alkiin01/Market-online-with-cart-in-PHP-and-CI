			...
			<div class="w-size13 p-t-30 respon5">
				<div class="wrap-slick3 flex-sb flex-w">
					...
					<div class="slick3">
						...
						?>
						<div class="item-slick3" data-thumb="<?php echo base_url('assets/upload/image/thumbs/').$gambar->gambar ?>" width=20%>
							<div class="wrap-pic-w">
...
<br>
				Ketersediaan barang : <?php echo $produk->stok ?>
				</span>
				...
				<!--  -->
					...
					<button type="submit" id="bAdd_<?php echo $produk->id_produk ?>" value="submit" class="flex-c-m size1 bg4 bo-rad-23 hov1 s-text1 trans-0-4 ">
		...
		<div class="block2-img wrap-pic-w of-hidden pos-relative block2-labelnew">
			...
			<div class="block2-overlay trans-0-4">
				...
				<div class="block2-btn-addcart w-size1 trans-0-4">
					<!-- Button -->
					<button type="submit" id="bAdd_<?php echo $produk_related->id_produk ?>" value="submit" class="flex-c-m size1 bg4 bo-rad-23 hov1 s-text1 trans-0-4" hidden="">
					Masukan ke keranjang
					</button>

					<button type="button" onclick="check_stock_1(<?php echo "'".$produk_related->id_produk."'" ?>)" class="flex-c-m size1 bg4 bo-rad-23 hov1 s-text1 trans-0-4">
					Masukan ke keranjang   
						</button>
				</div>
			</div>
