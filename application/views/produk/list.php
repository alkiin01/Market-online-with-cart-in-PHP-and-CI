						...
						alt="<?php echo $produk->nama_produk ?>">
							...
							<div class="block2-overlay trans-0-4">
								...
								<div class="block2-btn-addcart w-size1 trans-0-4"> 
									...
									<button type="submit" id="bAdd_<?php echo $produk->id_produk ?>" value="submit" class="flex-c-m size1 bg4 bo-rad-23 hov1 s-text1 trans-0-4" hidden="">
								Masukan ke keranjang
								</button>

								<button type="button" onclick="check_stock(<?php echo "'".$produk->id_produk."'" ?>)" class="flex-c-m size1 bg4 bo-rad-23 hov1 s-text1 trans-0-4">
								Masukan ke keranjang
								</button>
								</div>
							</div>
