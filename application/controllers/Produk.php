...
class Produk extends CI_Controller {
	...
	public function detail($slug_produk){
		...
		$komentar 	= $this->pelanggan_model->komentar();
	...
	public function komentar(){
		...
		$data = array(	'id_produk'		=> $i->post('id_produk'),
						...
						'tanggal_pos' => date('Y-m-d H:i:s')
					);
		$this->pelanggan_model->tambah_komentar($data);
		$this->session->flashdata('sukses','komentar berhasil ditambahkan');
